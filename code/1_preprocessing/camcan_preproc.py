...
RAW_DIR = ("/media/clement/CamCAN/MEG/data/BIDS_MEG_maxfiltered/cc700/meg/pipeline/release005/BIDSsep/derivatives_rest/aa/AA_movecomp/aamod_meg_maxfilt_00002")
...
if __name__ == "__main__":
    ...
    config = """
        ...
        - notch_filter: {freqs: 50 88 100 118, notch_widths: 2}
        - resample: {sfreq: 250}
